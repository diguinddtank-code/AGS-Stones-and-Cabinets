        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col items-center">
          ...
          >
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 border border-white/20 backdrop-blur-md mb-3">
              ...
              <span className="text-[10px] font-bold tracking-wider uppercase text-white/90">Accepting New Projects</span>
            </div>
          ...
          <motion.div 
            ...
            className="w-full max-w-lg mx-auto mt-4 flex flex-row items-center justify-center gap-3 sm:gap-4 text-white/90"
          >
            <div className="flex items-center gap-1.5 bg-white/10 px-3 py-2 rounded-full backdrop-blur-md border border-white/10 shadow-sm">
              <div className="flex -space-x-1">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-3 h-3 fill-secondary text-secondary" />
                ))}
              </div>
              <span className="text-[9px] sm:text-[10px] font-bold tracking-wider">5.0 RATING</span>
            </div>
            <div className="flex items-center gap-1.5 bg-white/10 px-3 py-2 rounded-full backdrop-blur-md border border-white/10 shadow-sm">
              <ShieldCheck className="w-3 h-3 text-green-400" />
              <span className="text-[9px] sm:text-[10px] font-bold tracking-wider">LICENSED</span>
            </div>
          </motion.div>
