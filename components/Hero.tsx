      ...
      >
        <div className="animate-in slide-in-from-bottom-10 fade-in duration-1000 delay-300 max-w-5xl">
            ...
            <div className="max-w-3xl mx-auto mb-12 space-y-4">
                <p className="text-lg md:text-2xl drop-shadow-lg text-gray-100 leading-relaxed font-light">
                   We offer a bespoke experience for homeowners, guiding you through every step of the material selection process.
                </p>
                <p className="text-base md:text-lg drop-shadow-lg text-gray-300 font-light max-w-2xl mx-auto">
                    From knowledgable advice to curating the materials, our team is dedicated to providing a stress-free experience tailored to your vision.
                </p>
            </div>
